drop table USER_FEEDBACK purge;
drop table "OAuth_RefreshTokens" purge;
drop table "OAuth_Clients" purge;
--drop table CUST_PMT_METHOD purge;
drop table USER_IMAGE purge;
...
--
drop table USER_TAG_ALT_NAME purge;
drop table POSTAL purge;
drop table USER_TAG purge;
--
drop table CITY_ALT_NAME purge;
drop table CITY purge;
--drop table COUNTY_ALT_NAME purge;
--
--drop table COUNTY purge;
drop table STATE_ALT_NAME purge;
drop table STATE purge;
--
drop table COUNTRY_ALT_NAME purge;
drop table COUNTRY_LANG purge;
drop table COUNTRY purge;
--
drop table continent_alt_name purge;
drop table continent purge;
--
drop table list_location_type purge;
drop table LIST_MEASUREMENT purge;
drop table LIST_CURRENCY purge;
drop table LIST_TIMEZONE purge;
...
------------------
drop index country_postal_code_stg_idx3;
drop index country_postal_code_stg_idx4;
drop index country_postal_code_stg_idx5;
--==================================================
create index country_postal_code_stg_idx3
on country_postal_code_stg (upper(ADMIN_NAME1));
--
create index country_postal_code_stg_idx4
on country_postal_code_stg (upper(ADMIN_NAME2));
--
create index country_postal_code_stg_idx5
on country_postal_code_stg (upper(PLACE_NAME));
--==================================================
...
create table LIST_TIMEZONE
    (TIMEZONE_CODE NUMBER(3)
    ,DESCR VARCHAR2(40)
    ,GMT_OFFSET NUMBER(4,2)
    ,DST_OFFSET NUMBER(4,2)
    ,RAW_OFFSET NUMBER(4,2)
    ,ACTIVE_FLAG           VARCHAR2(1)   DEFAULT 'Y' NOT NULL
    ,Z_CREATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
    ,Z_CREATE_TMSTMP       TIMESTAMP          DEFAULT systimestamp        NOT NULL
    ,Z_UPDATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
...
ALTER TABLE LIST_TIMEZONE ADD CONSTRAINT LIST_TIMEZONE_PK
PRIMARY KEY (TIMEZONE_CODE);
--==================================================
create table LIST_CURRENCY
    (CURRENCY_CODE VARCHAR2(3)
    ,DESCR VARCHAR2(30)
    ,HEX_SYMBOL VARCHAR2(20)
    ,supported_flag varchar2(1) default 'N'
    ,ACTIVE_FLAG           VARCHAR2(1)   DEFAULT 'Y' NOT NULL
    ,Z_CREATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
    ,Z_CREATE_TMSTMP       TIMESTAMP          DEFAULT systimestamp        NOT NULL
    ,Z_UPDATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
...
ALTER TABLE LIST_CURRENCY ADD CONSTRAINT LIST_CURRENCY_PK
PRIMARY KEY (CURRENCY_CODE);
--==================================================
create table LIST_MEASUREMENT
    (MEASUREMENT_CODE VARCHAR2(2)
    ,DESCR VARCHAR2(30)
    ,ACTIVE_FLAG           VARCHAR2(1)   DEFAULT 'Y' NOT NULL
    ,Z_CREATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
    ,Z_CREATE_TMSTMP       TIMESTAMP          DEFAULT systimestamp        NOT NULL
...
ALTER TABLE LIST_MEASUREMENT ADD CONSTRAINT LIST_MEASUREMENT_PK
PRIMARY KEY (MEASUREMENT_CODE);
--==================================================
...
ALTER TABLE continent ADD CONSTRAINT continent_PK
PRIMARY KEY (CONTINENT_CODE);
--==================================================
create table continent_alt_name 
    (CONTINENT_ALT_NAME_SN NUMBER(11)
    ,CONTINENT_CODE VARCHAR2(2) NOT NULL
    ,LANG_CODE  VARCHAR2(2) NOT NULL
    ,ALT_NAME NVARCHAR2(300)
    ,PREFERRED_NAME_FLAG VARCHAR2(1) DEFAULT 'N'
    ,SHORT_NAME_FLAG VARCHAR2(1) DEFAULT 'N'
    ,COLLOQUIAL_FLAG VARCHAR2(1) DEFAULT 'N'
    ,HISTORIC_FLAG VARCHAR2(1) DEFAULT 'N'
    ,ACTIVE_FLAG           VARCHAR2(1)   DEFAULT 'Y' NOT NULL
    ,Z_CREATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
    ,Z_CREATE_TMSTMP       TIMESTAMP          DEFAULT systimestamp        NOT NULL
    ,Z_UPDATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
...
ALTER TABLE continent_alt_name ADD CONSTRAINT continent_alt_name_PK
PRIMARY KEY (CONTINENT_ALT_NAME_SN);
----
ALTER TABLE continent_alt_name ADD CONSTRAINT continent_alt_name_FK1
FOREIGN KEY (CONTINENT_CODE) REFERENCES CONTINENT(CONTINENT_CODE);
--
ALTER TABLE continent_alt_name ADD CONSTRAINT continent_alt_name_FK2
FOREIGN KEY (LANG_CODE) REFERENCES list_LANG(LANG_CODE);
--
CREATE unique INDEX continent_alt_name_ak1 
ON continent_alt_name (CONTINENT_CODE,LANG_CODE);
--==================================================
create table COUNTRY
    (COUNTRY_CODE VARCHAR2(2)
    ,CONTINENT_CODE VARCHAR2(2) NOT NULL
    ,MEASUREMENT_CODE VARCHAR2(2) NOT NULL
    ,CURRENCY_CODE VARCHAR2(3)
...
FOREIGN KEY (MEASUREMENT_CODE) REFERENCES LIST_MEASUREMENT(MEASUREMENT_CODE);
--
ALTER TABLE COUNTRY ADD CONSTRAINT COUNTRY_FK3
FOREIGN KEY (CURRENCY_CODE) REFERENCES LIST_CURRENCY(CURRENCY_CODE);
--==================================================
create table COUNTRY_LANG
    (COUNTRY_LANG_SN NUMBER(11)
    ,COUNTRY_CODE VARCHAR2(2) NOT NULL
    ,LANG_CODE VARCHAR2(2) NOT NULL
    ,PRIMARY_LANG_FLAG     VARCHAR2(1)   DEFAULT 'N' NOT NULL
    ,ACTIVE_FLAG           VARCHAR2(1)   DEFAULT 'Y' NOT NULL
    ,Z_CREATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
    ,Z_CREATE_TMSTMP       TIMESTAMP          DEFAULT systimestamp        NOT NULL
    ,Z_UPDATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
...
ALTER TABLE COUNTRY_LANG ADD CONSTRAINT COUNTRY_LANG_PK
PRIMARY KEY (COUNTRY_LANG_SN);
--
ALTER TABLE COUNTRY_LANG ADD CONSTRAINT COUNTRY_LANG_FK1
FOREIGN KEY (COUNTRY_CODE) REFERENCES COUNTRY(COUNTRY_CODE);
--
ALTER TABLE COUNTRY_LANG ADD CONSTRAINT COUNTRY_LANG_FK2
FOREIGN KEY (LANG_CODE) REFERENCES LIST_LANG(LANG_CODE);
--
CREATE unique INDEX COUNTRY_LANG_ak1 
ON COUNTRY_LANG (COUNTRY_CODE,LANG_CODE);
--==================================================
create table COUNTRY_ALT_NAME
    (COUNTRY_ALT_NAME_SN NUMBER(11)
    ,COUNTRY_CODE VARCHAR2(2) NOT NULL
    ,LANG_CODE  VARCHAR2(2) NOT NULL
    ,ALT_NAME NVARCHAR2(300)
    ,PREFERRED_NAME_FLAG VARCHAR2(1) DEFAULT 'N'
...
ALTER TABLE COUNTRY_ALT_NAME ADD CONSTRAINT COUNTRY_ALT_NAME_PK
PRIMARY KEY (COUNTRY_ALT_NAME_SN);
--
ALTER TABLE COUNTRY_ALT_NAME ADD CONSTRAINT COUNTRY_ALT_NAME_FK1
FOREIGN KEY (COUNTRY_CODE) REFERENCES COUNTRY(COUNTRY_CODE);
--
ALTER TABLE COUNTRY_ALT_NAME ADD CONSTRAINT COUNTRY_ALT_NAME_FK2
FOREIGN KEY (LANG_CODE) REFERENCES LIST_LANG(LANG_CODE);
--
CREATE unique INDEX COUNTRY_ALT_NAME_ak1 
ON COUNTRY_ALT_NAME (COUNTRY_CODE,LANG_CODE);
--==================================================
create table STATE
    (STATE_SN NUMBER(11)
    ,COUNTRY_CODE VARCHAR2(2) NOT NULL
...
--==================================================
create table STATE_ALT_NAME
    (STATE_ALT_NAME_SN NUMBER(11)
...
ALTER TABLE STATE_ALT_NAME ADD CONSTRAINT STATE_ALT_NAME_PK
PRIMARY KEY (STATE_ALT_NAME_SN);
--
ALTER TABLE STATE_ALT_NAME ADD CONSTRAINT STATE_ALT_NAME_FK1
FOREIGN KEY (STATE_SN) REFERENCES STATE(STATE_SN);
--
ALTER TABLE STATE_ALT_NAME ADD CONSTRAINT STATE_ALT_NAME_FK2
FOREIGN KEY (LANG_CODE) REFERENCES LIST_LANG(LANG_CODE);
--
CREATE unique INDEX STATE_ALT_NAME_ak1 
ON STATE_ALT_NAME (STATE_SN,LANG_CODE);
--==================================================
create table CITY
    (CITY_SN NUMBER(11)
    ,STATE_SN NUMBER(11) NOT NULL
...
FOREIGN KEY (STATE_SN) REFERENCES STATE(STATE_SN);
--
ALTER TABLE CITY ADD CONSTRAINT CITY_FK2
FOREIGN KEY (TIMEZONE_CODE) REFERENCES LIST_TIMEZONE(TIMEZONE_CODE);
--
...
;
--==================================================
create table CITY_ALT_NAME
    (CITY_ALT_NAME_SN NUMBER(11)
...
ALTER TABLE CITY_ALT_NAME ADD CONSTRAINT CITY_ALT_NAME_PK
PRIMARY KEY (CITY_ALT_NAME_SN);
--
ALTER TABLE CITY_ALT_NAME ADD CONSTRAINT CITY_ALT_NAME_FK1
FOREIGN KEY (CITY_SN) REFERENCES CITY(CITY_SN);
--
ALTER TABLE CITY_ALT_NAME ADD CONSTRAINT CITY_ALT_NAME_FK2
FOREIGN KEY (LANG_CODE) REFERENCES LIST_LANG(LANG_CODE);
--
CREATE unique INDEX CITY_ALT_NAME_ak1 
ON CITY_ALT_NAME (CITY_SN,LANG_CODE);
--==================================================
create table USER_TAG
    (USER_TAG_SN NUMBER(11)
    ,CITY_SN NUMBER(11) NOT NULL
    ,NAME VARCHAR2(200) NOT NULL
    ,LOCATION_TYPE_CODE VARCHAR2(15)
    ,LATITUDE  NUMBER(9,6)
...
ALTER TABLE USER_TAG ADD CONSTRAINT USER_TAG_PK
PRIMARY KEY (USER_TAG_SN);
--
ALTER TABLE USER_TAG ADD CONSTRAINT USER_TAG_FK1
FOREIGN KEY (CITY_SN) REFERENCES CITY(CITY_SN);
--
ALTER TABLE USER_TAG ADD CONSTRAINT USER_TAG_FK2
FOREIGN KEY (LOCATION_TYPE_CODE) REFERENCES LIST_LOCATION_TYPE(LOCATION_TYPE_CODE);
--
CREATE unique INDEX USER_TAG_ak1 
ON USER_TAG (CITY_SN,NAME);
--==================================================
create table POSTAL
    (POSTAL_SN NUMBER(11)
    ,CITY_SN NUMBER(11) NOT NULL
...
--==================================================
create table USER_TAG_ALT_NAME
    (USER_TAG_ALT_NAME_SN NUMBER(11)
    ,USER_TAG_SN NUMBER(11) NOT NULL
    ,LANG_CODE  VARCHAR2(2) NOT NULL
    ,ALT_NAME NVARCHAR2(300)
    ,PREFERRED_NAME_FLAG VARCHAR2(1) DEFAULT 'N'
    ,SHORT_NAME_FLAG VARCHAR2(1) DEFAULT 'N'
...
ALTER TABLE USER_TAG_ALT_NAME ADD CONSTRAINT USER_TAG_ALT_NAME_PK
PRIMARY KEY (USER_TAG_ALT_NAME_SN);
--
ALTER TABLE USER_TAG_ALT_NAME ADD CONSTRAINT USER_TAG_ALT_NAME_FK1
FOREIGN KEY (USER_TAG_SN) REFERENCES USER_TAG(USER_TAG_SN);
--
ALTER TABLE USER_TAG_ALT_NAME ADD CONSTRAINT USER_TAG_ALT_NAME_FK2
FOREIGN KEY (LANG_CODE) REFERENCES LIST_LANG(LANG_CODE);
--
CREATE unique INDEX USER_TAG_ALT_NAME_ak1 
ON USER_TAG_ALT_NAME (USER_TAG_SN,LANG_CODE);
--==================================================
create table ADDR
    (ADDR_SN NUMBER(11)
...
CREATE TABLE "AspNetUsers" 
   (           "Id" NVARCHAR2(128) NOT NULL
                ...
                ,svc_provider_flag VARCHAR2(1)   DEFAULT 'N' NOT NULL
                ,ACTIVE_FLAG           VARCHAR2(1)   DEFAULT 'Y' NOT NULL
                ,Z_CREATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
                ,Z_CREATE_TMSTMP       TIMESTAMP          DEFAULT systimestamp        NOT NULL
                ,Z_UPDATE_USER_ID      VARCHAR2(20 BYTE)  DEFAULT substr(user,1,20)   NOT NULL
...
create table USER_IMAGE
    (USER_IMAGE_SN NUMBER(11)
    ,"Id" NVARCHAR2(128) NOT NULL
    ,IMAGE_SHORT_DESCR VARCHAR2(100)
    ,IMAGE_LONG_DESCR VARCHAR2(4000)
    ,ASPECT_RATIO VARCHAR2(30)
    ,RESOLUTION_PIXELS_PER_IN NUMBER(3)
    ,PIXEL_DIMENSION_W NUMBER(5)
    ,PIXEL_DIMENSION_H NUMBER(5)
    ,IMAGE BLOB
    ,file_name varchar2(200)
    ,file_type_code varchar2(10)
    ,ACTIVE_FLAG           VARCHAR2(1)   DEFAULT 'Y' NOT NULL
...
ALTER TABLE USER_IMAGE ADD CONSTRAINT USER_IMAGE_PK
PRIMARY KEY (USER_IMAGE_SN);
--
ALTER TABLE USER_IMAGE ADD CONSTRAINT USER_IMAGE_FK1
FOREIGN KEY ("Id") REFERENCES "AspNetUsers"("Id");
--
ALTER TABLE USER_IMAGE ADD CONSTRAINT USER_IMAGE_FK2
FOREIGN KEY (FILE_TYPE_CODE) REFERENCES LIST_FILE_TYPE(FILE_TYPE_CODE);
--==================================================
...
ALTER TABLE USER_FEEDBACK ADD CONSTRAINT USER_FEEDBACK_PK
PRIMARY KEY (USER_FEEDBACK_SN);
--
ALTER TABLE USER_FEEDBACK ADD CONSTRAINT USER_FEEDBACK_FK1
FOREIGN KEY (USER_ROLE_ID) REFERENCES "AspNetUserRoles"(USER_ROLE_ID);
--
ALTER TABLE USER_FEEDBACK ADD CONSTRAINT USER_FEEDBACK_FK2
FOREIGN KEY (LANG_CODE) REFERENCES LIST_LANG(LANG_CODE);
--======================================================
