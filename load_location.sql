...
begin
  ...
  loc_trans_pkg.load_LIST_CURRENCY;
  loc_trans_pkg.load_LIST_TIMEZONE;
  loc_trans_pkg.load_list_location_type;
  loc_trans_pkg.load_list_lang;
  loc_trans_pkg.load_continent;
  loc_trans_pkg.load_OAuth_Clients;
  loc_trans_pkg.load_LIST_MEASUREMENT;
  loc_trans_pkg.load_COUNTRY;
  loc_trans_pkg.load_COUNTRY_LANG;
  loc_trans_pkg.load_STATE;
--  loc_trans_pkg.load_CITY;
  loc_trans_pkg.load_continent_alt_name;
  loc_trans_pkg.load_COUNTRY_ALT_NAME;
  loc_trans_pkg.upd_COUNTRY_ALT_NAME;
